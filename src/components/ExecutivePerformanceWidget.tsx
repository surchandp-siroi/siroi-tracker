        ...
        <div className="w-full mb-6 relative overflow-hidden rounded-2xl bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 shadow-sm p-6 group">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap sm:flex-nowrap gap-3 w-full lg:w-auto shrink-0 justify-end">
                    ...
                    {/* Target Card */}
                    <div className="flex-1 lg:w-36 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-1.5">
                            <div className="p-1 rounded bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20">
                                <Target className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" />
                            </div>
                            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Total Target</span>
                        </div>
                        <div className="text-xl font-bold text-slate-900 dark:text-white font-mono tracking-tight">{formatCurrency(target)}</div>
                    </div>

                    {/* Achieved Card */}
                    <div className="flex-1 lg:w-36 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-1.5">
                            <div className="p-1 rounded bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20">
                                <TrendingUp className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                            </div>
                            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Total Achieved</span>
                        </div>
                        <div className="text-xl font-bold text-emerald-600 dark:text-emerald-400 font-mono tracking-tight">{formatCurrency(achieved)}</div>
                    </div>
                    
                    {/* Gap Card */}
                    <div className="flex-1 lg:w-36 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-1.5">
                            <div className="p-1 rounded bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20">
                                <Target className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
                            </div>
                            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Target Gap</span>
                        </div>
                        <div className="text-xl font-bold text-amber-600 dark:text-amber-400 font-mono tracking-tight">{formatCurrency(gap)}</div>
                    </div>

                    {/* Logged/Pipeline Card */}
                    <div className="flex-1 lg:w-36 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-1.5">
                            <div className="p-1 rounded bg-sky-50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-500/20">
                                <TrendingUp className="w-3.5 h-3.5 text-sky-600 dark:text-sky-400" />
                            </div>
                            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Logged Pipeline</span>
                        </div>
                        <div className="text-xl font-bold text-slate-900 dark:text-white font-mono tracking-tight">{formatCurrency(logged)}</div>
                    </div>
                </div>
