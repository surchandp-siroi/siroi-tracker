    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-4 text-center border-b-0 pb-0">
            <div className="mx-auto w-40 flex flex-col items-center justify-center mb-2 gap-4">
                <img 
                   src={siroiLogo} 
                   alt="Siroi Forex Logo" 
                   className="w-full object-contain filter brightness-0 dark:invert transition-all opacity-90"
                   onError={(e) => {
                ...
                />
                <div className="bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-500 dark:text-indigo-400 p-3 rounded-full w-16 h-16 flex items-center justify-center">
                    <TrendingUp size={32} />
                </div>
            </div>
