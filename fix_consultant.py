...
with open('src/pages/ConsultantApprovalPage.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Chunk 6 & 12: Extra closing divs removal (there are two blocks like this)
content = content.replace(
'''                    )}
                    </div>
                </div>
...
with open('src/pages/ConsultantApprovalPage.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
